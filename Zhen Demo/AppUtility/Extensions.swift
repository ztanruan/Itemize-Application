...
extension UIFont {
    ...
    public class func AppFontSemiBoldItalic(_ fontSize: CGFloat) -> UIFont {
        return UIFont(name: "OpenSans-SemiBoldItalic", size: fontSize)!
    }

    public class func AppFontExtraBoldItalic(_ fontSize: CGFloat) -> UIFont {
        return UIFont(name: "OpenSans-ExtraBoldItalic", size: fontSize)!
    }
    
    public class func AppFontLightItalic(_ fontSize: CGFloat) -> UIFont {
        return UIFont(name: "OpenSans-LightItalic", size: fontSize)!
    }
    
    public class func AppFontBoldItalic(_ fontSize: CGFloat) -> UIFont {
    ...
    public class func AppFontItalic(_ fontSize: CGFloat) -> UIFont {
