...
extension FirebaseManager {
    ...
    func GetAllItemListFromFirebaseStorage(_ strUID: String, completion:@escaping ([[String: Any]]?)->Void) {
        var arr_data = [[String: Any]]()
        let ref = Database.database().reference(withPath: "item_list").child(strUID)
        ref.observeSingleEvent(of: .value, with: { snapshot in
            if !snapshot.exists() {
                completion(arr_data)
            }
    ...
    func GetAllCategoryListFromFirebaseStorage(completion:@escaping ([[String: Any]]?)->Void) {
        var arr_data = [[String: Any]]()
    ...
    func getTypeListFromCategoryFromfirebase(_ catid: String, completion:@escaping ([[String: Any]]?)->Void) {
        var arr_data = [[String: Any]]()
        let ref = Database.database().reference(withPath: "category").child(catid).child("types")
        ref.observeSingleEvent(of: .value, with: { snapshot in
            if !snapshot.exists() {
                completion(arr_data)
            }
    ...
    func getBrandListFromCategoryFromfirebase(_ catid: String, type_id: String, completion:@escaping ([[String: Any]]?)->Void) {
        var arr_data = [[String: Any]]()
        let ref = Database.database().reference(withPath: "category").child(catid).child("types").child(type_id).child("brand")
        ref.observeSingleEvent(of: .value, with: { snapshot in
            if !snapshot.exists() {
                completion(arr_data)
            }
    ...
    func getLocationListFromCategoryFromfirebase(_ catid: String, typeid: String, brandid: String, completion:@escaping ([[String: Any]]?)->Void) {
        var arr_data = [[String: Any]]()
        let ref = Database.database().reference(withPath: "category").child(catid).child("types").child(typeid).child("brand").child(brandid).child("location")
        ref.observeSingleEvent(of: .value, with: { snapshot in
            if !snapshot.exists() {
                completion(arr_data)
            }
    ...
    //For Category Type
    func GetAllCategoryTypeListFromFirebaseStorage(cat_iddd: String,completion:@escaping ([[String: Any]]?)->Void) {
        var arr_data = [[String: Any]]()
        let ref = Database.database().reference(withPath: "category").child(cat_iddd).child("types")
        ref.observeSingleEvent(of: .value, with: { snapshot in
            if !snapshot.exists() {
                completion(arr_data)
            }
    ...
    //For Brand
    func GetAllCategoryTypeBrandListFromFirebaseStorage(completion:@escaping ([[String: Any]]?)->Void) {
        var arr_data = [[String: Any]]()
        let category_id = appDelegate.dic_valueforAddCatInAdmin["category_id"] as? String ?? ""
        let type_id = appDelegate.dic_valueforAddCatInAdmin["type_id"] as? String ?? ""
        let ref = Database.database().reference(withPath: "category").child(category_id).child("types").child(type_id).child("brand")
        ref.observeSingleEvent(of: .value, with: { snapshot in
            if !snapshot.exists() {
                completion(arr_data)
            }
    ...
    //For Location
    func GetAllCategoryTypeBrand_LocationListFromFirebaseStorage(completion:@escaping ([[String: Any]]?)->Void) {
        var arr_data = [[String: Any]]()
        let category_id = appDelegate.dic_valueforAddCatInAdmin["category_id"] as? String ?? ""
        let type_id = appDelegate.dic_valueforAddCatInAdmin["type_id"] as? String ?? ""
        let brand_id = appDelegate.dic_valueforAddCatInAdmin["brand_id"] as? String ?? ""
        let ref = Database.database().reference(withPath: "category").child(category_id).child("types").child(type_id).child("brand").child(brand_id).child("location")
        ref.observeSingleEvent(of: .value, with: { snapshot in
            if !snapshot.exists() {
                completion(arr_data)
            }
